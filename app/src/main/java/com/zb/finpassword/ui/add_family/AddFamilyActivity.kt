package com.zb.finpassword.ui.add_family
...
import com.zb.finpassword.utils.showDialogN
...
class AddFamilyActivity : BaseActivity() {
    ...
    fun setUi() {
        ...
        if (b != null) {
            ...
            teamId = b.getString(TEAM_ID).toString()


        }
        progressDialog = MyCustomProgressDialog(this@AddFamilyActivity)
        setFullScreen()
...
*/
    ...
    companion object {
        ...
        fun getStartIntent(context: Context, category: String,teamId:String): Intent {
            return Intent(context, AddFamilyActivity::class.java).putExtra(
                CATEGORY,
                category
            ).putExtra(
                TEAM_ID,
    ...
    fun getFieldData() {
        ...
        val call: Call<JsonObject> =
            apiService!!.getField(
                Prefs.getValue(this@AddFamilyActivity, AppConstant.USER_ID, "").toString(),
                Prefs.getValue(this@AddFamilyActivity, AppConstant.PASSWORD, "").toString(),
                Prefs.getValue(this@AddFamilyActivity, AppConstant.API_KEY, "").toString(),
                category
            )
    ...
    private fun callAddPrivacyDataApi() {
        ...
        data["userid"] = Prefs.getValue(this@AddFamilyActivity, AppConstant.USER_ID, "").toString()
        data["pwd"] = Prefs.getValue(this@AddFamilyActivity, AppConstant.PASSWORD, "").toString()
        data["key"] = Prefs.getValue(this@AddFamilyActivity, AppConstant.API_KEY, "").toString()
        data["typ"] = "familie"
        data["cat"] = category
        data["action"] = "insert"
        data["version"] = "3.2"
