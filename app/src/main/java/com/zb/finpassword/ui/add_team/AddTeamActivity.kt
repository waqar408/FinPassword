package com.zb.finpassword.ui.add_team
...
class AddTeamActivity : BaseActivity() {
    ...
    fun setUi() {
        ...
        progressDialog = MyCustomProgressDialog(this@AddTeamActivity)
        setFullScreen()
...
*/
    ...
    companion object {
        ...
        fun getStartIntent(context: Context, category: String,teamId:String): Intent {
            return Intent(context, AddTeamActivity::class.java).putExtra(
                CATEGORY,
                category
            ).putExtra(
                TEAM_ID,
    ...
    fun getFieldData() {
        ...
        val call: Call<JsonObject> =
            apiService!!.getField(
                Prefs.getValue(this@AddTeamActivity, AppConstant.USER_ID, "").toString(),
                Prefs.getValue(this@AddTeamActivity, AppConstant.PASSWORD, "").toString(),
                Prefs.getValue(this@AddTeamActivity, AppConstant.API_KEY, "").toString(),
                category
            )
    ...
    private fun callAddPrivacyDataApi() {
        ...
        data["userid"] = Prefs.getValue(this@AddTeamActivity, AppConstant.USER_ID, "").toString()
        data["pwd"] = Prefs.getValue(this@AddTeamActivity, AppConstant.PASSWORD, "").toString()
        data["key"] = Prefs.getValue(this@AddTeamActivity, AppConstant.API_KEY, "").toString()
        data["typ"] = "team"
        data["cat"] = category
        data["action"] = "insert"
        data["version"] = "3.2"
