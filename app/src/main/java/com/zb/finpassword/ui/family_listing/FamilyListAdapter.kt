...
import com.zb.finpassword.ui.edit_family.EditFamilyActivity
...
import com.zb.finpassword.ui.add_family.AddFamilyActivity
...
class FamilyListAdapter(private val mActivity: Context, private val mDataList: MutableList<TeamResponse>, var category: String,val subKeyList:ArrayList<String>) :
        ...
        when (holder.itemViewType) {
            HEADER -> {
                ...
                mHolder.imgAddCategory.setSafeOnClickListener {
                    mActivity.start2(
                        AddFamilyActivity.getStartIntent(
                            mActivity,
                            category.toString(),
            ...
            ITEM -> {
                ...
                mHolder.imgView.setSafeOnClickListener {
                    val intent = Intent(mActivity, EditFamilyActivity::class.java)
