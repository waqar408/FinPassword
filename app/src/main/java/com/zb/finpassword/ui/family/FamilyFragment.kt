package com.zb.finpassword.ui.family
...
import com.zb.finpassword.ui.privacy.HomeAdapter
...
class FamilyFragment : BaseFragment(R.layout.fragment_privacy) {
...
*/
                        ...
                        Log.e("familie", privacyKeyList.toString())

                        rv_home.apply {
                            adapter = HomeAdapter(requireActivity(),privacyValueList,privacyKeyList,"family")
                        }
