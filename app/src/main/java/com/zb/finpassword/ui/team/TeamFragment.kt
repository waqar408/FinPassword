package com.zb.finpassword.ui.team
...
class TeamFragment : BaseFragment(R.layout.fragment_privacy) {
...
*/
                        ...
                        Log.e("team", privacyKeyList.toString())

                        rv_home.apply {
                            adapter = HomeAdapter(requireActivity(),privacyValueList,privacyKeyList,"team")
                        }
